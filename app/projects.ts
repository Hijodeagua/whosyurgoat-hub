...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Model picks vs. the bookies — daily MLB predictions from a team Elo with a starter-adjusted shadow model, simulated scores, playoff futures, and a versioned, graded track record.",
    href: "/vegas",
    status: "live",
    emoji: "🎰",
    accent: "#3ddc84",
